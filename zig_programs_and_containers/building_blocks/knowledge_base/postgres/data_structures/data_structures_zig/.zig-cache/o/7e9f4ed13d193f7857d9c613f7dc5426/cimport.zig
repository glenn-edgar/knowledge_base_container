...
pub const kb_conn_t = extern struct {
    conn: ?*PGconn = @import("std").mem.zeroes(?*PGconn),
};
pub extern fn kb_connect(conninfo: [*c]const u8, out: [*c][*c]kb_conn_t) kb_error_t;
pub extern fn kb_connect_params(host: [*c]const u8, port: [*c]const u8, dbname: [*c]const u8, user: [*c]const u8, password: [*c]const u8, out: [*c][*c]kb_conn_t) kb_error_t;
pub extern fn kb_disconnect(c: [*c]kb_conn_t) void;
pub extern fn kb_commit(c: [*c]kb_conn_t) kb_error_t;
pub extern fn kb_rollback(c: [*c]kb_conn_t) kb_error_t;
pub extern fn kb_begin(c: [*c]kb_conn_t) kb_error_t;
pub const kb_resultset_t = extern struct {
    ncols: c_int = @import("std").mem.zeroes(c_int),
    nrows: c_int = @import("std").mem.zeroes(c_int),
    colnames: [*c][*c]u8 = @import("std").mem.zeroes([*c][*c]u8),
    values: [*c][*c][*c]u8 = @import("std").mem.zeroes([*c][*c][*c]u8),
    pg_result: ?*PGresult = @import("std").mem.zeroes(?*PGresult),
};
pub extern fn kb_query(c: [*c]kb_conn_t, sql: [*c]const u8, params: [*c]const [*c]const u8, nparams: c_int, rs: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_exec(c: [*c]kb_conn_t, sql: [*c]const u8, params: [*c]const [*c]const u8, nparams: c_int, affected: [*c]c_int) kb_error_t;
pub extern fn kb_exec_simple(c: [*c]kb_conn_t, sql: [*c]const u8) kb_error_t;
pub extern fn kb_resultset_free(rs: [*c]kb_resultset_t) void;
pub extern fn kb_rs_get(rs: [*c]const kb_resultset_t, row: c_int, col: [*c]const u8) [*c]const u8;
pub extern fn kb_rs_get_int(rs: [*c]const kb_resultset_t, row: c_int, col: [*c]const u8) c_int;
pub extern fn kb_rs_get_int64(rs: [*c]const kb_resultset_t, row: c_int, col: [*c]const u8) i64;
pub extern fn kb_rs_get_bool(rs: [*c]const kb_resultset_t, row: c_int, col: [*c]const u8) bool;
pub extern fn kb_strdup(s: [*c]const u8) [*c]u8;
pub extern fn kb_sprintf(fmt: [*c]const u8, ...) [*c]u8;
pub extern fn kb_escape_literal(c: [*c]kb_conn_t, str: [*c]const u8) [*c]u8;
pub extern fn kb_escape_identifier(c: [*c]kb_conn_t, str: [*c]const u8) [*c]u8;
pub const kb_retry_fn = ?*const fn ([*c]kb_conn_t, ?*anyopaque) callconv(.C) kb_error_t;
pub extern fn kb_retry(c: [*c]kb_conn_t, @"fn": kb_retry_fn, ctx: ?*anyopaque, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_timestamp_now() [*c]u8;
pub const kb_search_t = extern struct {
    conn: [*c]kb_conn_t = @import("std").mem.zeroes([*c]kb_conn_t),
    database: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    filter_count: c_int = @import("std").mem.zeroes(c_int),
    cte_parts: [16][*c]u8 = @import("std").mem.zeroes([16][*c]u8),
    last_result: [*c]kb_resultset_t = @import("std").mem.zeroes([*c]kb_resultset_t),
};
pub extern fn kb_search_create(conn: [*c]kb_conn_t, database: [*c]const u8, out: [*c][*c]kb_search_t) kb_error_t;
pub extern fn kb_search_destroy(ks: [*c]kb_search_t) void;
pub extern fn kb_search_clear(ks: [*c]kb_search_t) void;
pub extern fn kb_search_label(ks: [*c]kb_search_t, label: [*c]const u8) kb_error_t;
pub extern fn kb_search_name(ks: [*c]kb_search_t, name: [*c]const u8) kb_error_t;
pub extern fn kb_search_property_key(ks: [*c]kb_search_t, key: [*c]const u8) kb_error_t;
pub extern fn kb_search_property_value(ks: [*c]kb_search_t, key: [*c]const u8, value: [*c]const u8) kb_error_t;
pub extern fn kb_search_path(ks: [*c]kb_search_t, path_pattern: [*c]const u8) kb_error_t;
pub extern fn kb_search_execute(ks: [*c]kb_search_t) kb_error_t;
pub extern fn kb_search_results(ks: [*c]const kb_search_t) [*c]const kb_resultset_t;
pub extern fn kb_search_find_paths(ks: [*c]kb_search_t, label: [*c]const u8, name: [*c]const u8, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_search_find_description(ks: [*c]kb_search_t, path: [*c]const u8, json_out: [*c][*c]u8) kb_error_t;
pub const kb_prop_filter_t = extern struct {
    key: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    value: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub extern fn kb_search_find_nodes(ks: [*c]kb_search_t, label: [*c]const u8, name: [*c]const u8, props: [*c]const kb_prop_filter_t, nprops: c_int, path_pattern: [*c]const u8, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_status_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_job_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_stream_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_bit_structure_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_rpc_server_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_rpc_client_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_document_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_node_paths(ks: [*c]kb_search_t, label: [*c]const u8, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_link_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_find_link_mount_paths(ks: [*c]kb_search_t, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_free_paths(paths: [*c][*c]u8, count: c_int) void;
pub extern fn kb_status_get(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, data_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_status_set(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, data: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_status_set_multiple(c: [*c]kb_conn_t, database: [*c]const u8, paths: [*c][*c]const u8, data_values: [*c][*c]const u8, count: c_int, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub const kb_job_info_t = extern struct {
    found: bool = @import("std").mem.zeroes(bool),
    id: c_int = @import("std").mem.zeroes(c_int),
    data: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub extern fn kb_job_free_count(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_job_queued_count(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_job_active_count(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_job_push(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, data: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_job_peek(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, info_out: [*c]kb_job_info_t, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_job_complete(c: [*c]kb_conn_t, database: [*c]const u8, job_id: c_int, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_job_clear(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_job_list_pending(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_job_list_active(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_stream_push(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, data: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_stream_list(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, after: [*c]const u8, before: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_stream_clear(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_stream_count(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_stream_count_total(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_stream_latest(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_stream_range(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, start_time: [*c]const u8, end_time: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_stream_get_by_id(c: [*c]kb_conn_t, database: [*c]const u8, row_id: c_int, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_stream_statistics(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub const kb_rpc_server_job_t = extern struct {
    found: bool = @import("std").mem.zeroes(bool),
    id: c_int = @import("std").mem.zeroes(c_int),
    server_path: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    request_id: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    rpc_action: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    request_payload: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    transaction_tag: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    state: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    priority: c_int = @import("std").mem.zeroes(c_int),
    rpc_client_queue: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub extern fn kb_rpc_server_job_free(job: [*c]kb_rpc_server_job_t) void;
pub extern fn kb_rpc_server_count_new(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_rpc_server_count_processing(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_rpc_server_push(c: [*c]kb_conn_t, database: [*c]const u8, server_path: [*c]const u8, request_id: [*c]const u8, rpc_action: [*c]const u8, request_payload: [*c]const u8, transaction_tag: [*c]const u8, priority: c_int, client_path: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_rpc_server_peek(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, job_out: [*c]kb_rpc_server_job_t, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_rpc_server_complete(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, job_id: c_int, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_rpc_server_clear(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub const kb_rpc_client_reply_t = extern struct {
    found: bool = @import("std").mem.zeroes(bool),
    id: c_int = @import("std").mem.zeroes(c_int),
    request_id: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    client_path: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    server_path: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    rpc_action: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    response_payload: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub extern fn kb_rpc_client_reply_free(reply: [*c]kb_rpc_client_reply_t) void;
pub extern fn kb_rpc_client_free_slots(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_rpc_client_queued_slots(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_rpc_client_push_reply(c: [*c]kb_conn_t, database: [*c]const u8, client_path: [*c]const u8, request_id: [*c]const u8, server_path: [*c]const u8, rpc_action: [*c]const u8, transaction_tag: [*c]const u8, response_payload: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_rpc_client_peek_reply(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, reply_out: [*c]kb_rpc_client_reply_t, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_rpc_client_clear(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_bit_get_mask(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, mask_out: [*c]i64) kb_error_t;
pub extern fn kb_bit_set_mask(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, mask: i64, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_bit_set(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, bit_pos: c_int, value: bool, max_retries: c_int, base_delay_ms: c_int) kb_error_t;
pub extern fn kb_bit_get(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, bit_pos: c_int, value_out: [*c]bool) kb_error_t;
pub const kb_bit_def_t = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    bit_position: c_int = @import("std").mem.zeroes(c_int),
};
pub const kb_bit_defs_t = extern struct {
    defs: [*c]kb_bit_def_t = @import("std").mem.zeroes([*c]kb_bit_def_t),
    count: c_int = @import("std").mem.zeroes(c_int),
};
pub extern fn kb_bit_assemble_data(ks: [*c]kb_search_t, path: [*c]const u8, defs_out: [*c][*c]kb_bit_defs_t) kb_error_t;
pub extern fn kb_bit_defs_free(defs: [*c]kb_bit_defs_t) void;
pub extern fn kb_bit_eval_sexpr(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, sexpr_json: [*c]const u8, defs: [*c]const kb_bit_defs_t, prev_mask: i64, result_out: [*c]bool) kb_error_t;
pub extern fn kb_link_query(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_link_mount_query(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_link_query_by_name(c: [*c]kb_conn_t, database: [*c]const u8, link_name: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_link_mount_query_by_name(c: [*c]kb_conn_t, database: [*c]const u8, link_name: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_link_decode_nodes(c: [*c]kb_conn_t, database: [*c]const u8, path: [*c]const u8, paths_out: [*c][*c][*c]u8, count_out: [*c]c_int) kb_error_t;
pub extern fn kb_doc_get(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, as_text: bool, doc_type: [*c]const u8, value_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_set(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, value_json: [*c]const u8, create_missing: bool, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_delete_key(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, key: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_delete_path(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_has_key(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, key: [*c]const u8, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_has_any_keys(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, keys: [*c][*c]const u8, nkeys: c_int, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_has_all_keys(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, keys: [*c][*c]const u8, nkeys: c_int, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_contains(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, contained_json: [*c]const u8, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_contained_by(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, container_json: [*c]const u8, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_path_exists(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, jsonpath_query: [*c]const u8, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_path_query(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, jsonpath_query: [*c]const u8, doc_type: [*c]const u8, json_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_query(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, jsonb_filter: [*c]const u8, doc_type: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_doc_array_append(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, item_json: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_array_prepend(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, item_json: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_array_remove_index(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, index: c_int, doc_type: [*c]const u8, removed_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_array_contains(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, item_json: [*c]const u8, doc_type: [*c]const u8, result_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_array_elements(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, json_path: [*c]const u8, doc_type: [*c]const u8, rs_out: [*c][*c]kb_resultset_t) kb_error_t;
pub extern fn kb_doc_enqueue(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, item_json: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_dequeue(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8, item_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_peek(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, index: c_int, doc_type: [*c]const u8, item_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_queue_size(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8, size_out: [*c]c_int) kb_error_t;
pub extern fn kb_doc_queue_is_empty(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8, empty_out: [*c]bool) kb_error_t;
pub extern fn kb_doc_queue_clear(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_queue_get_all(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8, json_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_push(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, item_json: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
pub extern fn kb_doc_pop(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, queue_path: [*c]const u8, doc_type: [*c]const u8, item_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_get_metadata(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, metadata_path: [*c]const u8, doc_type: [*c]const u8, json_out: [*c][*c]u8) kb_error_t;
pub extern fn kb_doc_set_metadata(c: [*c]kb_conn_t, database: [*c]const u8, ltree_path: [*c]const u8, metadata_path: [*c]const u8, metadata_json: [*c]const u8, doc_type: [*c]const u8) kb_error_t;
...
// /usr/include/postgresql/postgres_ext.h:39:9
pub const atooid = @compileError("unable to translate macro: undefined identifier `strtoul`");
// /usr/include/postgresql/postgres_ext.h:42:9
...
pub const KB_SEARCH_H = "";
pub const KB_MAX_FILTERS = @as(c_int, 16);
pub const KB_STATUS_H = "";
