...
local function twenty_fourth_test(ct, kb_name)
    ...
    local port_0 = ct:make_port("stream_test_1.h", 0, "PACKET_GENERATOR_EVENT_1")
    local port_1 = ct:make_port("stream_test_1.h", 1, "PACKET_GENERATOR_EVENT_2")
...
local function twenty_fifth_test(ct, kb_name)
    ...
    local port_emitter_1 = ct:make_port("stream_test_1.h", 0, "EMITTER_1_EVENT")
    local port_emitter_2 = ct:make_port("stream_test_1.h", 0, "EMITTER_2_EVENT")
    local port_emitter_3 = ct:make_port("stream_test_1.h", 0, "EMITTER_3_EVENT")
...
local function twenty_sixth_test(ct, kb_name)
    ...
    local port_0 = ct:make_port("stream_test_1.h", 0, "SENSOR_EVENT")
