// ============================================================================
// external_tree_dump_32.h
// DEBUG PARAMETER DUMP for external_tree
// Mode: 32-bit
// Generated by s_expr_dsl v5.2
// ============================================================================

#ifndef EXTERNAL_TREE_DUMP_32_H
#define EXTERNAL_TREE_DUMP_32_H
 ...
 *   [0x0006] ( 6) hash=0x02153947 SE_SET_EXTERNAL_FIELD
 *
 ...
 *   [0x0008] ( 8) hash=0xA56C78DC SE_TICK_TREE
 *
...
/*
 * TREE: call_tree
 *   hash=0xEB1D0EBE nodes=7 ptrs=1
 ...
 *    1  MAIN      [0x09]      0      0  idx_to_ptr=0
 *    2    OPEN_CALL[0x07]      5      0  SE_SPAWN_TREE hash=0x756BC19A
 ...
 *    6      UINT[0x01]           -      -  128 (0x00000080)
 *    7    CLOSE[0x06]          0      -  (end SE_SPAWN_TREE)
 *    8    OPEN_CALL[0x07]      4      0  SE_SET_FIELD hash=0xFFF84A15
 *    9    ONESHOT   [0x08]      8      0  idx_to_ptr=0
 *   10      FIELD[0x0B]          8      4  dictionary_hash (off=0x0008, hash=0x5E462BC2)
 *   11      STR_HASH[0x03]       -      -  "init_all_peripherals" hash=0xBF310A69
 *   12    CLOSE[0x06]          0      -  (end SE_SET_FIELD)
 *   13    OPEN_CALL[0x07]      5      0  SE_SET_EXTERNAL_FIELD hash=0x02153947
 *   14    ONESHOT   [0x08]     13      6  idx_to_ptr=0
 *   15      FIELD[0x0B]          8      4  dictionary_hash (off=0x0008, hash=0x5E462BC2)
 *   16      FIELD[0x0B]          0      8  tree_pointer (off=0x0000, hash=0xD176F787)
 *   17      UINT[0x01]           -      -  8 (0x00000008)
 *   18    CLOSE[0x06]          0      -  (end SE_SET_EXTERNAL_FIELD)
 *   19    OPEN_CALL[0x07]      3      0  SE_TICK_TREE hash=0xA56C78DC
 *   20    MAIN      [0x09]     19      8  idx_to_ptr=0
 *   21      FIELD[0x0B]          0      8  tree_pointer (off=0x0000, hash=0xD176F787)
