...
class TopicSubscriber:
    ...
    def __init__(
        ...
        if use_mqttv5:
            # NOTE: do NOT pass clean_start here for v5; set it on connect()
        ...
        # Assign callbacks (VERSION2 signatures)
    ...
    def _on_connect(self, client, userdata, flags, reason_code, properties):
        ...
        """
        if self.use_mqttv5:
            self._connected = not getattr(reason_code, "is_failure", False) if hasattr(reason_code, "is_failure") else (reason_code == 0)
        else:
    ...
    def _on_message(self, client, userdata, msg):
        ...
        callbacks_to_execute: List[Callable[[MessageInfo], None]] = []
    ...
    def _topic_matches(self, topic: str, pattern: str) -> bool:
        ...
        """
        # Paho signature is (subscription, topic)
    ...
    def connect(self, timeout: float = 5.0) -> bool:
        ...
        try:
            ...
            if not self._connect_event.wait(timeout):
                ...
                self._running = False
                # stop loop after failed connect wait
    ...
    def disconnect(self) -> None:
        ...
        self._running = False
        try:
            # Prefer disconnect first, then stop loop to avoid races
    ...
    def add_callback(self, topic: str, callback: Callable[[MessageInfo], None]) -> bool:
        """
    ...
    def remove_callback(self, topic: str, callback: Callable[[MessageInfo], None]) -> bool:
        """
    ...
    def get_subscriptions(self) -> Dict[str, int]:
        """Return current subscriptions (topic -> qos)."""
        with self._subscriptions_lock:
