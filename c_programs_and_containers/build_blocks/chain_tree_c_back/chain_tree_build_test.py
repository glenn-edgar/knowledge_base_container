...
def thirteenth_test(ct,kb_name): # watch dog
    ...
    wd_node_id = ct.asm_watch_dog_node(wd_time_count=3,wd_reset=True,wd_fn="WATCH_DOG_TIME_OUT",
...
def insert_event_mask_df_b(ct):
    ...
    data_flow_mask_column = ct.define_data_flow_event_mask("df_mask",aux_function="DF_EXPRESSION",event_list=["b","c"])
...
def fourteenth_test(ct,kb_name): # data f
    ...
    register_event_column = insert_event_mask_df_b(ct)
...
if __name__ == "__main__":
    test_list = ["first_test","second_test","fourth_test","fifth_test","sixth_test","seventh_test","eighth_test",
                 "ninth_test","tenth_test","eleventh_test","twelfth_test","thirteenth_test","fourteenth_test",
                 "seventeenth_test","eighteenth_test"]
    ...
    test_dict = { "first_test": first_test, "second_test": second_test,  
                 ...
                 "fourteenth_test": fourteenth_test, "seventeenth_test": seventeenth_test,"eighteenth_test": eighteenth_test,}
    ...
    yaml_file = Path("c_results/basic_tests.yaml")
