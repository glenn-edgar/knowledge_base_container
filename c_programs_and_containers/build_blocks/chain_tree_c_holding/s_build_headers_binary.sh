...
# Requires:
#   - luajit
#   - libfnv1a.so (in lua_dsl/binary_image/luajit/)
...
# Add both binary dir (libfnv1a.so lives here) and c_lib to library path
export LD_LIBRARY_PATH="${BINARY_DIR}:${C_LIB_DIR}:${LD_LIBRARY_PATH:-}"
