...
class SExpressionNodes(ColumnFlow):
    ...
    def define_s_expression_link(self,module_name:str,tree_name:str,user_data:dict = {}):
        ...
        return self.define_column_link(main_function_name="CFL_S_EXPRESSION_LINK_MAIN", initialization_function_name="CFL_S_EXPRESSION_LINK_INIT", 
                      initialization_function ="CFL_S_EXPRESSION_LINK_INIT", termination_function ="CFL_S_EXPRESSION_LINK_TERM", 
                      aux_function_name ="CFL_NULL",column_data = column_data,label="S_EXP_LINK_NODE")
