...
def thirty_one_test(ct,kb_name): # data f
    ...
    ct.define_s_expression_link(module_name="chain_flow_dsl_tests",tree_name="s_expression_test_7",user_data={})
    ct.asm_log_message("s expression link node test 7 is not active")
    ct.asm_log_message("s expression link node test 8 is active")
    ct.define_s_expression_link(module_name="chain_flow_dsl_tests",tree_name="s_expression_test_8",user_data={})
