 ...
 * @return Pointer to initialized heap ( for runtime handle compatibility)
 * 
 ...
 * 
 * @param heap Pointer to heap (accepts )
 */
 ...
 * 
 * @param heap Pointer to heap (accepts )
 * @param stats Pointer to stats structure to fill (accepts )
 */
