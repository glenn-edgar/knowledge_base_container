...
const node_alias_t ct_r1ts0khl_kb_23_aliases[4] = {
...
const node_alias_t ct_r1ts0khl_kb_24_aliases[4] = {
...
const chaintree_kb_info_t ct_r1ts0khl_kb_table[28] = {
    {
        .kb_name = "first_test",
        .root_node_index = 0,
        .start_index = 0,
    ...
    },
    {
        ...
        .max_depth = 3,
        .memory_factor = 50,
        .aliases = ct_r1ts0khl_kb_23_aliases,
        .alias_count = 4
    },
    {
        ...
        .max_depth = 3,
        .memory_factor = 50,
        .aliases = ct_r1ts0khl_kb_24_aliases,
        .alias_count = 4
    },
    {
