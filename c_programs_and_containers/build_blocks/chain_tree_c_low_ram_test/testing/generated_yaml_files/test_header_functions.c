...
const main_function_t ct_r1ts0khl_main_functions[] = {
    cfl_null_main_fn,
...
const one_shot_function_t ct_r1ts0khl_one_shot_functions[] = {
...
const boolean_function_t ct_r1ts0khl_boolean_functions[] = {
    cfl_null_boolean_fn,
...
const uint16_t ct_r1ts0khl_main_function_usage_count[41] = {
    0,  /* CFL_NULL */
...
const char *ct_r1ts0khl_main_function_names[41] = {
    "CFL_NULL",
    "AVRO_VERIFY_PACKET",
...
const char *ct_r1ts0khl_one_shot_function_names[107] = {
    "CFL_NULL",
    "ACTIVATE_VALVE",
...
const char *ct_r1ts0khl_boolean_function_names[35] = {
    "CFL_NULL",
    "CATCH_ALL_EXCEPTION",
    "CFL_BOOL_FALSE",
    "CFL_COLUMN_NULL",
