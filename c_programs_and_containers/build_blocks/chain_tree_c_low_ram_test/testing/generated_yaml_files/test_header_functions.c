...
const main_function_t ct_e0kvy28a_main_functions[] = {
    cfl_null_main_fn,
...
const one_shot_function_t ct_e0kvy28a_one_shot_functions[] = {
...
const boolean_function_t ct_e0kvy28a_boolean_functions[] = {
    cfl_null_boolean_fn,
...
const uint16_t ct_e0kvy28a_main_function_usage_count[40] = {
    0,  /* CFL_NULL */
...
const char *ct_e0kvy28a_main_function_names[40] = {
    "CFL_NULL",
    "AVRO_VERIFY_PACKET",
...
const char *ct_e0kvy28a_one_shot_function_names[105] = {
    "CFL_NULL",
    "ACTIVATE_VALVE",
...
const char *ct_e0kvy28a_boolean_function_names[35] = {
    "CFL_NULL",
    "CATCH_ALL_EXCEPTION",
    "CFL_BOOL_FALSE",
    "CFL_COLUMN_NULL",
