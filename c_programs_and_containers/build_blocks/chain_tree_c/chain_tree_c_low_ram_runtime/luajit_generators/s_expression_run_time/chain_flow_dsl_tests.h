...
static const uint32_t chain_flow_dsl_tests_oneshot_hashes[] = {
    ...
    0x665D1C5CU,  // CFL_COPY_CONST_FULL
    0x3C18F4F2U,  // TEST_38_VERIFY_DEFAULTS
    0x0C5B0038U,  // CFL_COPY_CONST
    0x262F60C6U,  // TEST_38_VERIFY_TEST_PID
    0x83BFA6A9U,  // TEST_39_VERIFY_GAINS
    0x61B4DC54U  // TEST_39_VERIFY_POINTER
};
...
static const s_expr_field_desc_t chain_flow_dsl_tests_pid_gains_a_fields[] = {
    { .name_hash = 0x573D1A6EU, .offset = 0, .size = 4 },  // kp
    { .name_hash = 0x403CF639U, .offset = 4, .size = 4 },  // ki
    { .name_hash = 0x4B3D078AU, .offset = 8, .size = 4 }  // kd
};

static const s_expr_field_desc_t chain_flow_dsl_tests_test38_bb_fields[] = {
    { .name_hash = 0x9278AFF7U, .offset = 0, .size = 12 },  // gains
    { .name_hash = 0xA286B8C5U, .offset = 12, .size = 1 }  // verified
};

static const s_expr_field_desc_t chain_flow_dsl_tests_pid_gains_c_fields[] = {
    { .name_hash = 0x573D1A6EU, .offset = 0, .size = 4 },  // kp
    { .name_hash = 0x403CF639U, .offset = 4, .size = 4 },  // ki
    { .name_hash = 0x4B3D078AU, .offset = 8, .size = 4 }  // kd
};

static const s_expr_field_desc_t chain_flow_dsl_tests_test39_bb_fields[] = {
    { .name_hash = 0x9278AFF7U, .offset = 0, .size = 12 },  // gains
    { .name_hash = 0x84006F42U, .offset = 16, .size = 8 }  // gains_ptr
};
...
static const s_expr_record_desc_t chain_flow_dsl_tests_records[] = {
    ...
    {
        .name_hash = 0x7B154C19U,  // "pid_gains_a"
        .total_size = 12,
        .field_count = 3,
        .fields = chain_flow_dsl_tests_pid_gains_a_fields
    },
    {
        .name_hash = 0x47FFBBE3U,  // "test38_bb"
        .total_size = 16,
        .field_count = 2,
        .fields = chain_flow_dsl_tests_test38_bb_fields
    },
    {
        .name_hash = 0x791548F3U,  // "pid_gains_c"
        .total_size = 12,
        .field_count = 3,
        .fields = chain_flow_dsl_tests_pid_gains_c_fields
    },
    {
        .name_hash = 0x8D7DC5DEU,  // "test39_bb"
        .total_size = 24,
        .field_count = 2,
        .fields = chain_flow_dsl_tests_test39_bb_fields
    }
};
...
static const pid_gains_a_t chain_flow_dsl_tests_test_pid = {
    .kp = 2.500000f,
    .ki = 0.500000f,
    .kd = 0.100000f,
};

static const test38_bb_t chain_flow_dsl_tests_test38_defaults = {
    .gains = {
        .kp = 1.000000f,
        .ki = 0.200000f,
        .kd = 0.050000f,
...
// Constants pointer table
static const void* const chain_flow_dsl_tests_constants[] = {
    &chain_flow_dsl_tests_test_pid,  // index 0
    &chain_flow_dsl_tests_test38_defaults  // index 1
};
...
static const s_expr_param_t chain_flow_dsl_tests_s_expression_test_15_params[] = {
    { .type = 0x07, .brace_idx = 24 },
    { .type = 0x09, .index_to_pointer = 0, .node_index = 0, .func_index = 6 },  // CFL_PIPELINE
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 1, .func_index = 51 },  // CFL_COPY_CONST_FULL
    { .type = 0x0E, .const_index = 1, .const_size = 16 },  // test38_defaults
    { .type = 0x06, .brace_idx = 3 },
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 2, .func_index = 52 },  // TEST_38_VERIFY_DEFAULTS
    { .type = 0x0B, .field_offset = 0, .field_size = 12 },  // gains
    { .type = 0x06, .brace_idx = 3 },
    { .type = 0x07, .brace_idx = 4 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 3, .func_index = 53 },  // CFL_COPY_CONST
    { .type = 0x0B, .field_offset = 0, .field_size = 12 },  // gains
    { .type = 0x0E, .const_index = 0, .const_size = 12 },  // test_pid
    { .type = 0x06, .brace_idx = 4 },
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 4, .func_index = 54 },  // TEST_38_VERIFY_TEST_PID
    { .type = 0x0B, .field_offset = 0, .field_size = 12 },  // gains
    { .type = 0x06, .brace_idx = 3 },
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 5, .func_index = 5 },  // CFL_LOG
    { .type = 0x0D, .str_index = 46, .str_len = 13 },  // "Test 38: PASS"
    { .type = 0x06, .brace_idx = 3 },
    { .type = 0x0C, .int_val = 5 },  // SE_FUNCTION_TERMINATE
    { .type = 0x06, .brace_idx = 24 }
};

static const s_expr_param_t chain_flow_dsl_tests_s_expression_test_16_params[] = {
    { .type = 0x07, .brace_idx = 15 },
    { .type = 0x09, .index_to_pointer = 0, .node_index = 0, .func_index = 6 },  // CFL_PIPELINE
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 1, .func_index = 55 },  // TEST_39_VERIFY_GAINS
    { .type = 0x0B, .field_offset = 0, .field_size = 12 },  // gains
    { .type = 0x06, .brace_idx = 3 },
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 2, .func_index = 56 },  // TEST_39_VERIFY_POINTER
    { .type = 0x0B, .field_offset = 0, .field_size = 12 },  // gains
    { .type = 0x06, .brace_idx = 3 },
    { .type = 0x07, .brace_idx = 3 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 3, .func_index = 5 },  // CFL_LOG
...
static const s_expr_tree_def_t chain_flow_dsl_tests_s_expression_test_15_def = {
    .name_hash = 0x721805D5U,  // "s_expression_test_15"
    .record_hash = 0x47FFBBE3U,
    .params = chain_flow_dsl_tests_s_expression_test_15_params,
    .param_count = 25,
    .func_node_count = 6,
    .pointer_count = 0,
};

static const s_expr_tree_def_t chain_flow_dsl_tests_s_expression_test_16_def = {
    .name_hash = 0x6F18011CU,  // "s_expression_test_16"
    .record_hash = 0x8D7DC5DEU,
    .params = chain_flow_dsl_tests_s_expression_test_16_params,
    .param_count = 16,
    .func_node_count = 4,
    .pointer_count = 0,
};
...
static const s_expr_tree_def_t chain_flow_dsl_tests_trees[] = {
    ...
    chain_flow_dsl_tests_s_expression_test_15_def,
    chain_flow_dsl_tests_s_expression_test_16_def
};
...
static const s_expr_module_def_t chain_flow_dsl_tests_module = {
    ...
    .string_count = 47,
    .constants = chain_flow_dsl_tests_constants,
    .const_count = 2,
};
