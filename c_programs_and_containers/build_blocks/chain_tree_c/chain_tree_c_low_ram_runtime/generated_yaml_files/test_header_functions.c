...
extern unsigned cfl_s_expression_link_main_main_fn(void *handle, unsigned bool_function_index, unsigned node_index, unsigned event_type, unsigned event_id, void *event_data);
...
extern void cfl_s_expression_link_init_one_shot_fn(void *handle, unsigned node_index);
extern void cfl_s_expression_link_term_one_shot_fn(void *handle, unsigned node_index);
...
extern bool test_39_set_init_data_boolean_fn(void *handle, unsigned node_index, unsigned event_type, unsigned event_id, void *event_data);
...
const main_function_t ct_nw2f1pc5_main_functions[] = {
    cfl_null_main_fn,
    ...
    cfl_s_expression_link_main_main_fn,
...
const one_shot_function_t ct_nw2f1pc5_one_shot_functions[] = {
    ...
    cfl_s_expression_link_init_one_shot_fn,
    cfl_s_expression_link_term_one_shot_fn,
...
const boolean_function_t ct_nw2f1pc5_boolean_functions[] = {
    cfl_null_boolean_fn,
...
const uint16_t ct_nw2f1pc5_main_function_usage_count[41] = {
    0,  /* CFL_NULL */
...
const char *ct_nw2f1pc5_main_function_names[41] = {
    "CFL_NULL",
    "AVRO_VERIFY_PACKET",
...
const char *ct_nw2f1pc5_one_shot_function_names[107] = {
    "CFL_NULL",
    "ACTIVATE_VALVE",
...
const char *ct_nw2f1pc5_boolean_function_names[36] = {
    "CFL_NULL",
    "CATCH_ALL_EXCEPTION",
    "CFL_BOOL_FALSE",
    "CFL_COLUMN_NULL",
