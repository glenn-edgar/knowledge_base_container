 ...
 */
 ...
 #define CT_OK                    0
 #define CT_ERR_NULL_PTR         -1
 #define CT_ERR_TOO_SMALL        -2
 #define CT_ERR_BAD_MAGIC        -3
 #define CT_ERR_BAD_VERSION      -4
 #define CT_ERR_BAD_CHECKSUM     -5
 #define CT_ERR_BAD_SIZE         -6
 #define CT_ERR_SECTION_OOB      -7
 #define CT_ERR_ALLOC            -8
 #define CT_ERR_HASH_NOT_FOUND   -9
 #define CT_ERR_UNREGISTERED    -10
