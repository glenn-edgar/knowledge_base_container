...
start_tree("return_pipeline_reset_continue_test")
    se_return_pipeline_reset_continue()
end_tree("return_pipeline_reset_continue_test")

start_tree("return_pipeline_reset_halt_test")
    se_return_pipeline_reset_halt()
end_tree("return_pipeline_reset_halt_test")
