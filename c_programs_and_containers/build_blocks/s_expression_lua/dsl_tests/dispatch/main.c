...
#include "dispatch_test_lua_registration.h"

extern void dispatch_test_register_all(s_expr_module_t* module);
extern void dispatch_test_register_lua(s_expr_module_t* module);
...
static void register_user_functions(s_engine_handle_t* engine) {
    // C-native functions (excludes lua-declared ones)
    dispatch_test_register_all(&engine->module);
    
    // Lua trampoline entries (generated code)
    dispatch_test_register_lua(&engine->module);
}
...
static lua_State* init_lua(const char* lua_script_path) {
    ...
    // Initialize the bridge (creates registry, inst metatable, se_bridge global)
    se_lua_bridge_init(L);
    
    // Load the Lua function script
...
int main(int argc, char* argv[]) {
    printf("\n");
    printf("╔════════════════════════════════════════════════════════════════╗\n");
    printf("║           S-EXPRESSION ENGINE DISPATCH TEST (LUA)              ║\n");
    printf("╚════════════════════════════════════════════════════════════════╝\n\n");
    ...
    // ========================================================================
    // STEP 1: Initialize Lua and load function scripts
    // ========================================================================
