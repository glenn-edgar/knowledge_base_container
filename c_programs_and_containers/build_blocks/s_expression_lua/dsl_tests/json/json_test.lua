...
-- Four passes:
--   Pass 1: String path extraction (hash extract via Lua)
--   Pass 2: Hash path extraction (hash extract via Lua)
...
-- ============================================================================
-- LUA DICT EXTRACT HELPERS
-- Same DSL signature as se_dict_extract_hash / se_dict_extract_hash_h
-- but routes to Lua trampolines instead of C builtins
-- ============================================================================
...
se_function_interface(function()
    ...
    -- Hash extractions via Lua (string path)
    ...
    -- Hash extractions via Lua (hash path)
    lua_dict_extract_hash_h("dict_hash", 
        {"hashes", "state_idle"}, 
        "hash_val_1")
    lua_dict_extract_hash_h("dict_hash", 
