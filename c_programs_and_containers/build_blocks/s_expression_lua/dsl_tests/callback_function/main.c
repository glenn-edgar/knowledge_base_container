...
#include "callback_function_lua_registration.h"
...
static void register_user_functions(s_engine_handle_t* engine) {
    ...
    callback_function_register_lua(&engine->module);
}
...
static void test_dispatch(s_engine_handle_t* engine) {
    printf("\n╔════════════════════════════════════════╗\n");
    printf("║    CALLBACK FUNCTION TEST (LUA)        ║\n");
    printf("╚════════════════════════════════════════╝\n");
    
    printf("\nTesting callback function with tick loop...\n");
...
int main(int argc, char* argv[]) {
    printf("\n");
    printf("╔════════════════════════════════════════════════════════════════╗\n");
    printf("║        S-EXPRESSION ENGINE CALLBACK TEST (LUA)                 ║\n");
    printf("╚════════════════════════════════════════════════════════════════╝\n\n");
    ...
    // ========================================================================
    // STEP 2: Initialize engine with Lua handle in allocator ctx
    // ========================================================================
