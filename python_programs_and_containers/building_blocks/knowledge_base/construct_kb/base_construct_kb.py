...
class KnowledgeBaseManager:
    ...
    @classmethod
    def from_connection(cls, table_name: str, connection: psycopg2.extensions.connection):
        """
        Create KnowledgeBaseManager instance from an existing psycopg2 connection.
        ...
        Returns:
            KnowledgeBaseManager instance using the provided connection
        """
        ...
        instance._external_connection = True
        
        # Store connection params for reference (extract from connection if needed)
        try:
            dsn_params = connection.get_dsn_parameters()
            instance.connection_params = {
        ...
        instance.cursor.execute("CREATE EXTENSION IF NOT EXISTS ltree;")
