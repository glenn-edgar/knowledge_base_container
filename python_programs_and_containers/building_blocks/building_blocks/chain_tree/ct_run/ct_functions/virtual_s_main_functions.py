class VirtualSMainFunctions:
    def __init__(self,handle,valid_return_codes):
        ...
        self.valid_return_codes.append("CFL_TERMINATE_FUNCTION")
        self.valid_return_codes.append("CFL_FUNCTION_RETURN")
        self.valid_return_codes.append("CFL_FUNCTION_HALT")
        self.handle = handle
