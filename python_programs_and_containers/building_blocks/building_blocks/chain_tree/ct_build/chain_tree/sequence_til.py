...
class SequenceTil(ColumnFlow):
    ...
    def define_sequence_start_node(self,column_name:str,main_function ="CFL_SEQUENCE_START_MAIN",
        ...
        self.ctb.one_shot_function_mapping[finalize_function] = True
        column_data = {}
    ...
    def exception_catch(self,column_name:str,
        ...
        self.ctb.one_shot_function_mapping[logging_function_name] = True
        self.ctb.boolean_function_mapping[default_exception_handler_name] = True
