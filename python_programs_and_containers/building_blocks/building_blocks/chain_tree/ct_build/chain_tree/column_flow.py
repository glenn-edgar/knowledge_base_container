...
class ColumnFlow():
    ...
    def define_column(self, column_name:str,  main_function ="CFL_COLUMN_MAIN",
        ...
        self.ctb.one_shot_function_mapping[initialization_function] = True
        self.ctb.boolean_function_mapping[aux_function] = True
        self.ctb.one_shot_function_mapping[termination_function] = True
        return column_name
