...
from data_structures.kb_query_support import KB_Search
from data_structures.kb_status_data import KB_Status_Data
from data_structures.kb_job_table import KB_Job_Queue
from data_structures.kb_stream import KB_Stream
from data_structures.kb_rpc_client import KB_RPC_Client
from data_structures.kb_rpc_server import KB_RPC_Server
from data_structures.kb_link_table import KB_Link_Table
from data_structures.kb_link_mount_table import KB_Link_Mount_Table
...
class KB_Data_Structures:
    ...
    def __init__(self, host, port, dbname, user, password, database):
        """
        Initialize KB_Data_Structures with connection parameters.
        ...
        Args:
            ...
            database (str): The name of the knowledge base table.
        """
        # Create KB_Search with connection parameters
        self.query_support = KB_Search(host, port, dbname, user, password, database)
        
        # Initialize all components
        self._initialize_components(database)
        self._map_component_methods()
    
    @classmethod
    def from_connection(cls, connection: psycopg2.extensions.connection, database: str):
        """
        Create KB_Data_Structures instance from an existing psycopg2 connection.
        
        Args:
            connection: Existing psycopg2 connection object
            database: The name of the knowledge base table
            
        Returns:
            KB_Data_Structures instance using the provided connection
        """
        # Create instance without calling __init__
        instance = cls.__new__(cls)
        
        # Create KB_Search with existing connection
        instance.query_support = KB_Search.from_connection(connection, database)
        
        # Initialize all components
        instance._initialize_components(database)
        instance._map_component_methods()
        
        return instance
    
    def _initialize_components(self, database: str):
        """
        Initialize all data structure components.
        ...
        self.link_table = KB_Link_Table(
            self.query_support.conn, 
            self.query_support.cursor, 
            database
        )
        self.link_mount_table = KB_Link_Mount_Table(
            self.query_support.conn, 
            self.query_support.cursor, 
            database
        )
    
    def _map_component_methods(self):
        """
        Map all component methods to this class for convenience.
        This provides a flat API where all methods are accessible directly
        from the KB_Data_Structures instance.
        """
        # Map query support methods
        self._map_query_support_methods()
        
        # Map status data methods
        self._map_status_data_methods()
        
        # Map job queue methods
        self._map_job_queue_methods()
        
        # Map stream methods
        self._map_stream_methods()
        
        # Map RPC client methods
        self._map_rpc_client_methods()
        
        # Map RPC server methods
        self._map_rpc_server_methods()
        
        # Map link table methods
        self._map_link_table_methods()
        
        # Map link mount table methods
        self._map_link_mount_table_methods()
    
    def _map_query_support_methods(self):
        """Map KB_Search query support methods."""
    ...
    def _map_status_data_methods(self):
        """Map KB_Status_Data methods."""
    ...
    def _map_job_queue_methods(self):
        """Map KB_Job_Queue methods."""
    ...
    def _map_stream_methods(self):
        """Map KB_Stream methods."""
    ...
    def _map_rpc_client_methods(self):
        """Map KB_RPC_Client methods."""
    ...
    def _map_rpc_server_methods(self):
        """Map KB_RPC_Server methods."""
    ...
    def _map_link_table_methods(self):
        """Map KB_Link_Table methods."""
    ...
    def _map_link_mount_table_methods(self):
        """Map KB_Link_Mount_Table methods."""
    ...
    def connection(self):
        ...
        return self.query_support.conn
    
    @property
    def cursor(self):
        """Get the underlying database cursor."""
        return self.query_support.cursor
    
    def close(self):
        """Close the database connection if it was created internally."""
        if hasattr(self.query_support, 'close'):
            self.query_support.close()
