-- main.lua -- Single path test (no missions)
--
-- Tests just path following through multiple segments.
...
-- Multi-segment path: launch -> inspection (4 segments through waypoints)
local plan = {
  actions = {
    {
      action_type    = "path",
      ...
      step           = 1,
      segments       = {
        { from = "launch", to = "warehouse", nav = "spline_follow",
          speed = 120, distance = 400 },
        { from = "warehouse", to = "corridor_n", nav = "line_follow",
          speed = 120, distance = 400 },
        { from = "corridor_n", to = "crossroads", nav = "spline_follow",
          speed = 150, distance = 800 },
        { from = "crossroads", to = "inspection", nav = "spline_follow",
          speed = 130, distance = 400 },
      },
    },
  },
  mission_order = {},
  total_cost = 2000,
  virtual_route = { "launch", "inspection" },
}
...
-- Run
---------------------------------------------------------------------------
print("=== Single Path Test (4 segments) ===\n")
seq:start()
