...
--
-- Usage:
--   luajit compile_mission.lua [--plan] [--tree] [--kb] [--bindings] [--all]
------------------------------------------------------------------------
...
local Equipment = dofile(script_dir .. "equipment_dsl.lua")
local Map       = dofile(script_dir .. "map_dsl.lua")
local Mission   = dofile(script_dir .. "mission_dsl.lua")
local Spline    = dofile(script_dir .. "spline.lua")
...
if FLAGS.plan then
    ...
    print(plan_text)
    local f = io.open(script_dir .. "plan_expanded.txt", "w")
...
if FLAGS.tree then
    ...
    local f = io.open(script_dir .. "mission_tree.lua", "w")
...
if FLAGS.kb then
    ...
    local f = io.open(script_dir .. "robot_kb.sql", "w")
...
if FLAGS.bindings then
    ...
    local f = io.open(script_dir .. "bindings.json", "w")
