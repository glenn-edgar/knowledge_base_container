...
-- ============================================================================
-- s_compile.lua
-- S-Expression Engine DSL Compiler - Version 5.2
--
-- Generates:
...
local function print_usage()
    print([[
S-Expression Engine DSL Compiler v5.2
...
Options:
  ...
  --all-bin            Generate all outputs including binary and Lua module
...
Version 5.2 Features:
  - --lua flag serializes module_data as a static Lua table
  - LuaJIT runtime loads _module.lua directly, no DSL compilation at startup
  - s_engine_helpers.lua and s_expr_dsl.lua not needed at runtime
...
Examples:
  ...
  luajit s_compile.lua my_module.lua --lua=my_runtime_module.lua
...
local function serialize_module_lua(module_data)
    ...
    table.insert(lines, "-- DO NOT EDIT - Generated by s_compile.lua v5.2")
    table.insert(lines, "-- ============================================================================")
    table.insert(lines, "")
...
local function main()
    ...
    print("  Binary format:     v5.2 (direct s_expr_param_t, zero-copy)")
end
